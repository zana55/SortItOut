var Ds=Object.defineProperty;var Ls=(o,i,e)=>i in o?Ds(o,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[i]=e;var R=(o,i,e)=>Ls(o,typeof i!="symbol"?i+"":i,e);import{l as Fs,u as Ms,d as F,a as gi,w as L,s as vi,b as Ns,f as Bs,r as bi,P as k,m as Hs,c as $s,h as M,i as Vs,e as S,g as j,j as Q,D as ue,k as q,E as se,n as Ws,o as Oe,p as Gs,q as Qt,t as Xt}from"./generated-flow-imports-IG436xZy.js";import{b as Us,c as yi,e as qs,T as js,B as Ci,x as xi,f as D,g as E,i as y,a as Ks,h as $,j as wi}from"./indexhtml-C374O2S9.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zn=(o,i)=>(o==null?void 0:o._$litType$)!==void 0,Ys=o=>o.strings===void 0;/**
@license
...
*/class Y{constructor(){this._asyncModule=null,this._callback=null,this._timer=null}setConfig(i,e){this._asyncModule=i,this._callback=e,this._timer=this._asyncModule.run(()=>{this._timer=null,Re.delete(this),this._callback()})}cancel(){this.isActive()&&(this._cancelAsync(),Re.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return this._timer!=null}static debounce(i,e,t){return i instanceof Y?i._cancelAsync():i=new Y,i.setConfig(e,t),i}}let Re=new Set;const Qs=function(o){Re.add(o)},Xs=function(){const o=!!Re.size;return Re.forEach(i=>{try{i.flush()}catch(e){setTimeout(()=>{throw e})}}),o};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Zs=function(){let o,i;do o=window.ShadyDOM&&ShadyDOM.flush(),window.ShadyCSS&&window.ShadyCSS.ScopingShim&&window.ShadyCSS.ScopingShim.flush(),i=Xs();while(o||i)};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Zt=!1;function Js(){if(Fs&&!Ms){if(!Zt){Zt=!0;const o=document.createElement("style");o.textContent="dom-bind,dom-if,dom-repeat{display:none;}",document.head.appendChild(o)}return!0}return!1}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function It(o,i,e,t,s){let r;s&&(r=typeof e=="object"&&e!==null,r&&(t=o.__dataTemp[i]));let n=t!==e&&(t===t||e===e);return r&&n&&(o.__dataTemp[i]=e),n}const St=F(o=>{class i extends o{_shouldPropertyChange(t,s,r){return It(this,t,s,r,!0)}}return i});F(o=>{class i extends o{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(t,s,r){return It(this,t,s,r,this.mutableData)}}return i});St._mutablePropertyChange=It;/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let gt=null;function vt(){return gt}vt.prototype=Object.create(HTMLTemplateElement.prototype,{constructor:{value:vt,writable:!0}});const Ai=gi(vt),eo=St(Ai);function to(o,i){gt=o,Object.setPrototypeOf(o,i.prototype),new i,gt=null}const io=gi(class{});function Ei(o,i){for(let e=0;e<i.length;e++){let t=i[e];if(!!o!=!!t.__hideTemplateChildren__)if(t.nodeType===Node.TEXT_NODE)o?(t.__polymerTextContent__=t.textContent,t.textContent=""):t.textContent=t.__polymerTextContent__;else if(t.localName==="slot")if(o)t.__polymerReplaced__=document.createComment("hidden-slot"),L(L(t).parentNode).replaceChild(t.__polymerReplaced__,t);else{const s=t.__polymerReplaced__;s&&L(L(s).parentNode).replaceChild(t,s)}else t.style&&(o?(t.__polymerDisplay__=t.style.display,t.style.display="none"):t.style.display=t.__polymerDisplay__);t.__hideTemplateChildren__=o,t._showHideChildren&&t._showHideChildren(o)}}class oe extends io{constructor(i){super(),this._configureProperties(i),this.root=this._stampTemplate(this.__dataHost);let e=[];this.children=e;for(let s=this.root.firstChild;s;s=s.nextSibling)e.push(s),s.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);let t=this.__templatizeOptions;(i&&t.instanceProps||!t.instanceProps)&&this._enableProperties()}_configureProperties(i){if(this.__templatizeOptions.forwardHostProp)for(let t in this.__hostProps)this._setPendingProperty(t,this.__dataHost["_host_"+t]);for(let t in i)this._setPendingProperty(t,i[t])}forwardHostProp(i,e){this._setPendingPropertyOrPath(i,e,!1,!0)&&this.__dataHost._enqueueClient(this)}_addEventListenerToNode(i,e,t){if(this._methodHost&&this.__templatizeOptions.parentModel)this._methodHost._addEventListenerToNode(i,e,s=>{s.model=this,t(s)});else{let s=this.__dataHost.__dataHost;s&&s._addEventListenerToNode(i,e,t)}}_showHideChildren(i){Ei(i,this.children)}_setUnmanagedPropertyToNode(i,e,t){i.__hideTemplateChildren__&&i.nodeType==Node.TEXT_NODE&&e=="textContent"?i.__polymerTextContent__=t:super._setUnmanagedPropertyToNode(i,e,t)}get parentModel(){let i=this.__parentModel;if(!i){let e;i=this;do i=i.__dataHost.__dataHost;while((e=i.__templatizeOptions)&&!e.parentModel);this.__parentModel=i}return i}dispatchEvent(i){return!0}}oe.prototype.__dataHost;oe.prototype.__templatizeOptions;oe.prototype._methodHost;oe.prototype.__templatizeOwner;oe.prototype.__hostProps;const so=St(oe);function Jt(o){let i=o.__dataHost;return i&&i._methodHost||i}function oo(o,i,e){let t=e.mutableData?so:oe;bt.mixin&&(t=bt.mixin(t));let s=class extends t{};return s.prototype.__templatizeOptions=e,s.prototype._bindTemplate(o),ao(s,o,i,e),s}function ro(o,i,e,t){let s=e.forwardHostProp;if(s&&i.hasHostProps){const r=o.localName=="template";let n=i.templatizeTemplateClass;if(!n){if(r){let l=e.mutableData?eo:Ai;class u extends l{}n=i.templatizeTemplateClass=u}else{const l=o.constructor;class u extends l{}n=i.templatizeTemplateClass=u}let a=i.hostProps;for(let l in a)n.prototype._addPropertyEffect("_host_"+l,n.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:no(l,s)}),n.prototype._createNotifyingProperty("_host_"+l);Ns&&t&&co(i,e,t)}if(o.__dataProto&&Object.assign(o.__data,o.__dataProto),r)to(o,n),o.__dataTemp={},o.__dataPending=null,o.__dataOld=null,o._enableProperties();else{Object.setPrototypeOf(o,n.prototype);const a=i.hostProps;for(let l in a)if(l="_host_"+l,l in o){const u=o[l];delete o[l],o.__data[l]=u}}}}function no(o,i){return function(t,s,r){i.call(t.__templatizeOwner,s.substring(6),r[s])}}function ao(o,i,e,t){let s=e.hostProps||{};for(let r in t.instanceProps){delete s[r];let n=t.notifyInstanceProp;n&&o.prototype._addPropertyEffect(r,o.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:lo(r,n)})}if(t.forwardHostProp&&i.__dataHost)for(let r in s)e.hasHostProps||(e.hasHostProps=!0),o.prototype._addPropertyEffect(r,o.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:ho()})}function lo(o,i){return function(t,s,r){i.call(t.__templatizeOwner,t,s,r[s])}}function ho(){return function(i,e,t){i.__dataHost._setPendingPropertyOrPath("_host_"+e,t[e],!0,!0)}}function bt(o,i,e){if(vi&&!Jt(o))throw new Error("strictTemplatePolicy: template owner not trusted");if(e=e||{},o.__templatizeOwner)throw new Error("A <template> can only be templatized once");o.__templatizeOwner=i;let s=(i?i.constructor:oe)._parseTemplate(o),r=s.templatizeInstanceClass;r||(r=oo(o,s,e),s.templatizeInstanceClass=r);const n=Jt(o);ro(o,s,e,n);let a=class extends r{};return a.prototype._methodHost=n,a.prototype.__dataHost=o,a.prototype.__templatizeOwner=i,a.prototype.__hostProps=s.hostProps,a=a,a}function co(o,i,e){const t=e.constructor._properties,{propertyEffects:s}=o,{instanceProps:r}=i;for(let n in s)if(!t[n]&&!(r&&r[n])){const a=s[n];for(let l=0;l<a.length;l++){const{part:u}=a[l].info;if(!(u.signature&&u.signature.static)){console.warn(`Property '${n}' used in template but not declared in 'properties'; attribute will not be observed.`);break}}}}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/class Ii extends k{static get is(){return"dom-if"}static get template(){return null}static get properties(){return{if:{type:Boolean,observer:"__debounceRender"},restamp:{type:Boolean,observer:"__debounceRender"},notifyDomChange:{type:Boolean}}}constructor(){super(),this.__renderDebouncer=null,this._lastIf=!1,this.__hideTemplateChildren__=!1,this.__template,this._templateInfo}__debounceRender(){this.__renderDebouncer=Y.debounce(this.__renderDebouncer,Hs,()=>this.__render()),Qs(this.__renderDebouncer)}disconnectedCallback(){super.disconnectedCallback();const i=L(this).parentNode;(!i||i.nodeType==Node.DOCUMENT_FRAGMENT_NODE&&!L(i).host)&&this.__teardownInstance()}connectedCallback(){super.connectedCallback(),Js()||(this.style.display="none"),this.if&&this.__debounceRender()}__ensureTemplate(){if(!this.__template){const i=this;let e=i._templateInfo?i:L(i).querySelector("template");if(!e){let t=new MutationObserver(()=>{if(L(this).querySelector("template"))t.disconnect(),this.__render();else throw new Error("dom-if requires a <template> child")});return t.observe(this,{childList:!0}),!1}this.__template=e}return!0}__ensureInstance(){let i=L(this).parentNode;if(this.__hasInstance()){let e=this.__getInstanceNodes();if(e&&e.length&&L(this).previousSibling!==e[e.length-1])for(let s=0,r;s<e.length&&(r=e[s]);s++)L(i).insertBefore(r,this)}else{if(!i||!this.__ensureTemplate())return!1;this.__createAndInsertInstance(i)}return!0}render(){Zs()}__render(){if(this.if){if(!this.__ensureInstance())return}else this.restamp&&this.__teardownInstance();this._showHideChildren(),(!$s||this.notifyDomChange)&&this.if!=this._lastIf&&(this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0})),this._lastIf=this.if)}__hasInstance(){}__getInstanceNodes(){}__createAndInsertInstance(i){}__teardownInstance(){}_showHideChildren(){}}class uo extends Ii{constructor(){super(),this.__instance=null,this.__syncInfo=null}__hasInstance(){return!!this.__instance}__getInstanceNodes(){return this.__instance.templateInfo.childNodes}__createAndInsertInstance(i){const e=this.__dataHost||this;if(vi&&!this.__dataHost)throw new Error("strictTemplatePolicy: template owner not trusted");const t=e._bindTemplate(this.__template,!0);t.runEffects=(s,r,n)=>{let a=this.__syncInfo;if(this.if)a&&(this.__syncInfo=null,this._showHideChildren(),r=Object.assign(a.changedProps,r)),s(r,n);else if(this.__instance)if(a||(a=this.__syncInfo={runEffects:s,changedProps:{}}),n)for(const l in r){const u=bi(l);a.changedProps[u]=this.__dataHost[u]}else Object.assign(a.changedProps,r)},this.__instance=e._stampTemplate(this.__template,t),L(i).insertBefore(this.__instance,this)}__syncHostProperties(){const i=this.__syncInfo;i&&(this.__syncInfo=null,i.runEffects(i.changedProps,!1))}__teardownInstance(){const i=this.__dataHost||this;this.__instance&&(i._removeBoundDom(this.__instance),this.__instance=null,this.__syncInfo=null)}_showHideChildren(){const i=this.__hideTemplateChildren__||!this.if;this.__instance&&!!this.__instance.__hidden!==i&&(this.__instance.__hidden=i,Ei(i,this.__instance.templateInfo.childNodes)),i||this.__syncHostProperties()}}class _o extends Ii{constructor(){super(),this.__ctor=null,this.__instance=null,this.__invalidProps=null}__hasInstance(){return!!this.__instance}__getInstanceNodes(){return this.__instance.children}__createAndInsertInstance(i){this.__ctor||(this.__ctor=bt(this.__template,this,{mutableData:!0,forwardHostProp:function(e,t){this.__instance&&(this.if?this.__instance.forwardHostProp(e,t):(this.__invalidProps=this.__invalidProps||Object.create(null),this.__invalidProps[bi(e)]=!0))}})),this.__instance=new this.__ctor,L(i).insertBefore(this.__instance.root,this)}__teardownInstance(){if(this.__instance){let i=this.__instance.children;if(i&&i.length){let e=L(i[0]).parentNode;if(e){e=L(e);for(let t=0,s;t<i.length&&(s=i[t]);t++)e.removeChild(s)}}this.__invalidProps=null,this.__instance=null}}__syncHostProperties(){let i=this.__invalidProps;if(i){this.__invalidProps=null;for(let e in i)this.__instance._setPendingProperty(e,this.__dataHost[e]);this.__instance._flushProperties()}}_showHideChildren(){const i=this.__hideTemplateChildren__||!this.if;this.__instance&&!!this.__instance.__hidden!==i&&(this.__instance.__hidden=i,this.__instance._showHideChildren(i)),i||this.__syncHostProperties()}}const ei=Bs?uo:_o;customElements.define(ei.is,ei);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ke=(o,i)=>{var t;const e=o._$AN;if(e===void 0)return!1;for(const s of e)(t=s._$AO)==null||t.call(s,i,!1),ke(s,i);return!0},qe=o=>{let i,e;do{if((i=o._$AM)===void 0)break;e=i._$AN,e.delete(o),o=i}while((e==null?void 0:e.size)===0)},Si=o=>{for(let i;i=o._$AM;o=i){let e=i._$AN;if(e===void 0)i._$AN=e=new Set;else if(e.has(o))break;e.add(o),mo(i)}};function po(o){this._$AN!==void 0?(qe(this),this._$AM=o,Si(this)):this._$AM=o}function fo(o,i=!1,e=0){const t=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(i)if(Array.isArray(t))for(let r=e;r<t.length;r++)ke(t[r],!1),qe(t[r]);else t!=null&&(ke(t,!1),qe(t));else ke(this,o)}const mo=o=>{o.type==yi.CHILD&&(o._$AP??(o._$AP=fo),o._$AQ??(o._$AQ=po))};class go extends Us{constructor(){super(...arguments),this._$AN=void 0}_$AT(i,e,t){super._$AT(i,e,t),Si(this),this.isConnected=i._$AU}_$AO(i,e=!0){var t,s;i!==this.isConnected&&(this.isConnected=i,i?(t=this.reconnected)==null||t.call(this):(s=this.disconnected)==null||s.call(this)),e&&(ke(this,i),qe(this))}setValue(i){if(Ys(this._$Ct))this._$Ct._$AI(i,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=i,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}class vo extends go{constructor(i){if(super(i),i.type!==yi.CHILD)throw new Error(`${this.constructor.directiveName}() can only be used in child bindings`)}update(i,[e,t]){return this.updateContent(i,e,t),js}updateContent(i,e,t){const{parentNode:s,startNode:r}=i,n=t!=null,a=n?this.getNewNode(e,t):null,l=this.getOldNode(i);if(clearTimeout(this.__nodeRetryTimeout),n&&!a)this.__nodeRetryTimeout=setTimeout(()=>this.updateContent(i,e,t));else{if(l===a)return;l&&a?s.replaceChild(a,l):l?s.removeChild(l):a&&r.after(a)}}getNewNode(i,e){return window.Vaadin.Flow.clients[i].getByNodeId(e)}getOldNode(i){const{startNode:e,endNode:t}=i;if(e.nextSibling!==t)return e.nextSibling}disconnected(){clearTimeout(this.__nodeRetryTimeout)}}const Ti=qs(vo);function bo(o,i){return Ti(o,i)}function yo(o,i,e){Ci(xi`${i.map(t=>Ti(o,t))}`,e)}function Co(o){const i=o.insertBefore;o.insertBefore=function(e,t){return t&&t.parentNode===this?i.call(this,e,t):i.call(this,e,null)}}window.Vaadin||(window.Vaadin={});var mi;(mi=window.Vaadin).FlowComponentHost||(mi.FlowComponentHost={patchVirtualContainer:Co,getNode:bo,setChildNodes:yo});class ti extends k{static get template(){return M`
      <style>
        :host {
      ...
      <slot></slot>
    `}static get is(){return"flow-component-renderer"}static get properties(){return{nodeid:Number,appid:String}}static get observers(){return["_attachRenderedComponentIfAble(appid, nodeid)"]}ready(){super.ready(),this.addEventListener("click",function(i){this.firstChild&&typeof this.firstChild.click=="function"&&i.target===this&&(i.stopPropagation(),this.firstChild.click())}),this.addEventListener("animationend",this._onAnimationEnd)}_asyncAttachRenderedComponentIfAble(){this._debouncer=Y.debounce(this._debouncer,Vs,()=>this._attachRenderedComponentIfAble())}_attachRenderedComponentIfAble(){if(this.appid==null)return;if(this.nodeid==null){this.firstChild&&this.removeChild(this.firstChild);return}const i=this._getRenderedComponent();this.firstChild?i?this.firstChild!==i?(this.replaceChild(i,this.firstChild),this._defineFocusTarget(),this.onComponentRendered()):(this._defineFocusTarget(),this.onComponentRendered()):this._asyncAttachRenderedComponentIfAble():i?(this.appendChild(i),this._defineFocusTarget(),this.onComponentRendered()):this._asyncAttachRenderedComponentIfAble()}_getRenderedComponent(){try{return window.Vaadin.Flow.clients[this.appid].getByNodeId(this.nodeid)}catch(i){console.error("Could not get node %s from app %s",this.nodeid,this.appid),console.error(i)}return null}onComponentRendered(){}_defineFocusTarget(){var i=this._getFirstFocusableDescendant(this.firstChild);i!==null&&i.setAttribute("focus-target","true")}_getFirstFocusableDescendant(i){if(this._isFocusable(i))return i;if(i.hasAttribute&&(i.hasAttribute("disabled")||i.hasAttribute("hidden"))||!i.children)return null;for(var e=0;e<i.children.length;e++){var t=this._getFirstFocusableDescendant(i.children[e]);if(t!==null)return t}return null}_isFocusable(i){return i.hasAttribute&&typeof i.hasAttribute=="function"&&(i.hasAttribute("disabled")||i.hasAttribute("hidden"))?!1:i.tabIndex===0}_onAnimationEnd(i){i.animationName.indexOf("flow-component-renderer-appear")===0&&this._attachRenderedComponentIfAble()}}window.customElements.define(ti.is,ti);/**
 * @license
 * Copyright (c) 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function Tt(o,i){return o.split(".").reduce((e,t)=>e?e[t]:void 0,i)}/**
 * @license
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Eo=!1,Io=o=>o,Pt=typeof document.head.style.touchAction=="string",je="__polymerGestures",nt="__polymerGesturesHandled",yt="__polymerGesturesTouchAction",si=25,oi=5,So=2,To=["mousedown","mousemove","mouseup","click"],Oo=[0,1,4,2],zo=function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch{return!1}}();function Rt(o){return To.indexOf(o)>-1}let Ri=!1;(function(){try{const o=Object.defineProperty({},"passive",{get(){Ri=!0}});window.addEventListener("test",null,o),window.removeEventListener("test",null,o)}catch{}})();function Di(o){if(!(Rt(o)||o==="touchend")&&Pt&&Ri&&Eo)return{passive:!0}}const ko=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u),Po={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function de(o){const i=o.type;if(!Rt(i))return!1;if(i==="mousemove"){let t=o.buttons===void 0?1:o.buttons;return o instanceof window.MouseEvent&&!zo&&(t=Oo[o.which]||0),!!(t&1)}return(o.button===void 0?0:o.button)===0}function Ro(o){if(o.type==="click"){if(o.detail===0)return!0;const i=te(o);if(!i.nodeType||i.nodeType!==Node.ELEMENT_NODE)return!0;const e=i.getBoundingClientRect(),t=o.pageX,s=o.pageY;return!(t>=e.left&&t<=e.right&&s>=e.top&&s<=e.bottom)}return!1}const K={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function Do(o){let i="auto";const e=Fi(o);for(let t=0,s;t<e.length;t++)if(s=e[t],s[yt]){i=s[yt];break}return i}function Li(o,i,e){o.movefn=i,o.upfn=e,document.addEventListener("mousemove",i),document.addEventListener("mouseup",e)}function fe(o){document.removeEventListener("mousemove",o.movefn),document.removeEventListener("mouseup",o.upfn),o.movefn=null,o.upfn=null}const Fi=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:o=>o.composedPath&&o.composedPath()||[],X={},le=[];function Lo(o,i){let e=document.elementFromPoint(o,i),t=e;for(;t&&t.shadowRoot&&!window.ShadyDOM;){const s=t;if(t=t.shadowRoot.elementFromPoint(o,i),s===t)break;t&&(e=t)}return e}function te(o){const i=Fi(o);return i.length>0?i[0]:o.target}function Mi(o){const i=o.type,t=o.currentTarget[je];if(!t)return;const s=t[i];if(!s)return;if(!o[nt]&&(o[nt]={},i.startsWith("touch"))){const n=o.changedTouches[0];if(i==="touchstart"&&o.touches.length===1&&(K.touch.id=n.identifier),K.touch.id!==n.identifier)return;Pt||(i==="touchstart"||i==="touchmove")&&Fo(o)}const r=o[nt];if(!r.skip){for(let n=0,a;n<le.length;n++)a=le[n],s[a.name]&&!r[a.name]&&a.flow&&a.flow.start.indexOf(o.type)>-1&&a.reset&&a.reset();for(let n=0,a;n<le.length;n++)a=le[n],s[a.name]&&!r[a.name]&&(r[a.name]=!0,a[i](o))}}function Fo(o){const i=o.changedTouches[0],e=o.type;if(e==="touchstart")K.touch.x=i.clientX,K.touch.y=i.clientY,K.touch.scrollDecided=!1;else if(e==="touchmove"){if(K.touch.scrollDecided)return;K.touch.scrollDecided=!0;const t=Do(o);let s=!1;const r=Math.abs(K.touch.x-i.clientX),n=Math.abs(K.touch.y-i.clientY);o.cancelable&&(t==="none"?s=!0:t==="pan-x"?s=n>r:t==="pan-y"&&(s=r>n)),s?o.preventDefault():be("track")}}function he(o,i,e){return X[i]?(Mo(o,i,e),!0):!1}function Ni(o,i,e){return X[i]?(No(o,i,e),!0):!1}function Mo(o,i,e){const t=X[i],s=t.deps,r=t.name;let n=o[je];n||(o[je]=n={});for(let a=0,l,u;a<s.length;a++)l=s[a],!(ko&&Rt(l)&&l!=="click")&&(u=n[l],u||(n[l]=u={_count:0}),u._count===0&&o.addEventListener(l,Mi,Di(l)),u[r]=(u[r]||0)+1,u._count=(u._count||0)+1);o.addEventListener(i,e),t.touchAction&&Ho(o,t.touchAction)}function No(o,i,e){const t=X[i],s=t.deps,r=t.name,n=o[je];if(n)for(let a=0,l,u;a<s.length;a++)l=s[a],u=n[l],u&&u[r]&&(u[r]=(u[r]||1)-1,u._count=(u._count||1)-1,u._count===0&&o.removeEventListener(l,Mi,Di(l)));o.removeEventListener(i,e)}function tt(o){le.push(o),o.emits.forEach(i=>{X[i]=o})}function Bo(o){for(let i=0,e;i<le.length;i++){e=le[i];for(let t=0,s;t<e.emits.length;t++)if(s=e.emits[t],s===o)return e}return null}function Ho(o,i){Pt&&o instanceof HTMLElement&&j.run(()=>{o.style.touchAction=i}),o[yt]=i}function Dt(o,i,e){const t=new Event(i,{bubbles:!0,cancelable:!0,composed:!0});if(t.detail=e,Io(o).dispatchEvent(t),t.defaultPrevented){const s=e.preventer||e.sourceEvent;s&&s.preventDefault&&s.preventDefault()}}function be(o){const i=Bo(o);i.info&&(i.info.prevent=!0)}tt({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){fe(this.info)},mousedown(o){if(!de(o))return;const i=te(o),e=this,t=r=>{de(r)||(we("up",i,r),fe(e.info))},s=r=>{de(r)&&we("up",i,r),fe(e.info)};Li(this.info,t,s),we("down",i,o)},touchstart(o){we("down",te(o),o.changedTouches[0],o)},touchend(o){we("up",te(o),o.changedTouches[0],o)}});function we(o,i,e,t){i&&Dt(i,o,{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:t,prevent(s){return be(s)}})}tt({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(o){this.moves.length>So&&this.moves.shift(),this.moves.push(o)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,fe(this.info)},mousedown(o){if(!de(o))return;const i=te(o),e=this,t=r=>{const n=r.clientX,a=r.clientY;ri(e.info,n,a)&&(e.info.state=e.info.started?r.type==="mouseup"?"end":"track":"start",e.info.state==="start"&&be("tap"),e.info.addMove({x:n,y:a}),de(r)||(e.info.state="end",fe(e.info)),i&&at(e.info,i,r),e.info.started=!0)},s=r=>{e.info.started&&t(r),fe(e.info)};Li(this.info,t,s),this.info.x=o.clientX,this.info.y=o.clientY},touchstart(o){const i=o.changedTouches[0];this.info.x=i.clientX,this.info.y=i.clientY},touchmove(o){const i=te(o),e=o.changedTouches[0],t=e.clientX,s=e.clientY;ri(this.info,t,s)&&(this.info.state==="start"&&be("tap"),this.info.addMove({x:t,y:s}),at(this.info,i,e),this.info.state="track",this.info.started=!0)},touchend(o){const i=te(o),e=o.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:e.clientX,y:e.clientY}),at(this.info,i,e))}});function ri(o,i,e){if(o.prevent)return!1;if(o.started)return!0;const t=Math.abs(o.x-i),s=Math.abs(o.y-e);return t>=oi||s>=oi}function at(o,i,e){if(!i)return;const t=o.moves[o.moves.length-2],s=o.moves[o.moves.length-1],r=s.x-o.x,n=s.y-o.y;let a,l=0;t&&(a=s.x-t.x,l=s.y-t.y),Dt(i,"track",{state:o.state,x:e.clientX,y:e.clientY,dx:r,dy:n,ddx:a,ddy:l,sourceEvent:e,hover(){return Lo(e.clientX,e.clientY)}})}tt({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(o){de(o)&&(this.info.x=o.clientX,this.info.y=o.clientY)},click(o){de(o)&&ni(this.info,o)},touchstart(o){const i=o.changedTouches[0];this.info.x=i.clientX,this.info.y=i.clientY},touchend(o){ni(this.info,o.changedTouches[0],o)}});function ni(o,i,e){const t=Math.abs(i.clientX-o.x),s=Math.abs(i.clientY-o.y),r=te(e||i);!r||Po[r.localName]&&r.hasAttribute("disabled")||(isNaN(t)||isNaN(s)||t<=si&&s<=si||Ro(i))&&(o.prevent||Dt(r,"tap",{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:e}))}/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const $o=o=>class extends o{static get properties(){return{width:{type:String,value:"58px",sync:!0},flexGrow:{type:Number,value:0,sync:!0},selectAll:{type:Boolean,value:!1,notify:!0,sync:!0},autoSelect:{type:Boolean,value:!1,sync:!0},dragSelect:{type:Boolean,value:!1,sync:!0},_indeterminate:{type:Boolean,sync:!0},_selectAllHidden:Boolean}}static get observers(){return["_onHeaderRendererOrBindingChanged(_headerRenderer, _headerCell, path, header, selectAll, _indeterminate, _selectAllHidden)"]}_defaultHeaderRenderer(e,t){let s=e.firstElementChild;s||(s=document.createElement("vaadin-checkbox"),s.setAttribute("aria-label","Select All"),s.classList.add("vaadin-grid-select-all-checkbox"),e.appendChild(s),s.addEventListener("checked-changed",this.__onSelectAllCheckedChanged.bind(this)));const r=this.__isChecked(this.selectAll,this._indeterminate);s.__rendererChecked=r,s.checked=r,s.hidden=this._selectAllHidden,s.indeterminate=this._indeterminate}_defaultRenderer(e,t,{item:s,selected:r}){let n=e.firstElementChild;n||(n=document.createElement("vaadin-checkbox"),n.setAttribute("aria-label","Select Row"),e.appendChild(n),n.addEventListener("checked-changed",this.__onSelectRowCheckedChanged.bind(this)),he(e,"track",this.__onCellTrack.bind(this)),e.addEventListener("mousedown",this.__onCellMouseDown.bind(this)),e.addEventListener("click",this.__onCellClick.bind(this))),n.__item=s,n.__rendererChecked=r,n.checked=r}__onSelectAllCheckedChanged(e){e.target.checked!==e.target.__rendererChecked&&(this._indeterminate||e.target.checked?this._selectAll():this._deselectAll())}__onSelectRowCheckedChanged(e){e.target.checked!==e.target.__rendererChecked&&(e.target.checked?this._selectItem(e.target.__item):this._deselectItem(e.target.__item))}__onCellTrack(e){if(this.dragSelect)if(this.__dragCurrentY=e.detail.y,this.__dragDy=e.detail.dy,e.detail.state==="start"){const s=this._grid._getRenderedRows().find(r=>r.contains(e.currentTarget.assignedSlot));this.__selectOnDrag=!this._grid._isSelected(s._item),this.__dragStartIndex=s.index,this.__dragStartItem=s._item,this.__dragAutoScroller()}else e.detail.state==="end"&&(this.__dragStartItem&&(this.__selectOnDrag?this._selectItem(this.__dragStartItem):this._deselectItem(this.__dragStartItem)),setTimeout(()=>{this.__dragStartIndex=void 0}))}__onCellMouseDown(e){this.dragSelect&&e.preventDefault()}__onCellClick(e){this.__dragStartIndex!==void 0&&e.preventDefault()}_onCellKeyDown(e){const t=e.composedPath()[0];if(e.keyCode===32&&(t===this._headerCell||this._cells.includes(t)&&!this.autoSelect)){const s=t._content.firstElementChild;s.checked=!s.checked}}__dragAutoScroller(){if(this.__dragStartIndex===void 0)return;const e=this._grid._getRenderedRows(),t=e.find(l=>{const u=l.getBoundingClientRect();return this.__dragCurrentY>=u.top&&this.__dragCurrentY<=u.bottom});let s=t?t.index:void 0;const r=this.__getScrollableArea();this.__dragCurrentY<r.top?s=this._grid._firstVisibleIndex:this.__dragCurrentY>r.bottom&&(s=this._grid._lastVisibleIndex),s!==void 0&&e.forEach(l=>{(s>this.__dragStartIndex&&l.index>=this.__dragStartIndex&&l.index<=s||s<this.__dragStartIndex&&l.index<=this.__dragStartIndex&&l.index>=s)&&(this.__selectOnDrag?this._selectItem(l._item):this._deselectItem(l._item),this.__dragStartItem=void 0)});const n=r.height*.15,a=10;if(this.__dragDy<0&&this.__dragCurrentY<r.top+n){const l=r.top+n-this.__dragCurrentY,u=Math.min(1,l/n);this._grid.$.table.scrollTop-=u*a}if(this.__dragDy>0&&this.__dragCurrentY>r.bottom-n){const l=this.__dragCurrentY-(r.bottom-n),u=Math.min(1,l/n);this._grid.$.table.scrollTop+=u*a}setTimeout(()=>this.__dragAutoScroller(),10)}__getScrollableArea(){const e=this._grid.$.table.getBoundingClientRect(),t=this._grid.$.header.getBoundingClientRect(),s=this._grid.$.footer.getBoundingClientRect();return{top:e.top+t.height,bottom:e.bottom-s.height,left:e.left,right:e.right,height:e.height-t.height-s.height,width:e.width}}_selectAll(){}_deselectAll(){}_selectItem(e){}_deselectItem(e){}__isChecked(e,t){return t||e}};class Ct extends $o(Pi){static get is(){return"vaadin-grid-flow-selection-column"}static get properties(){return{autoWidth:{type:Boolean,value:!0},width:{type:String,value:"56px"}}}_defaultHeaderRenderer(i,e){super._defaultHeaderRenderer(i,e);const t=i.firstElementChild;t&&(t.id="selectAllCheckbox")}_selectAll(){this.selectAll=!0,this.$server.selectAll()}_deselectAll(){this.selectAll=!1,this.$server.deselectAll()}_selectItem(i){this._grid.$connector.doSelection([i],!0)}_deselectItem(i){this._grid.$connector.doDeselection([i],!0),this.selectAll=!1}}customElements.define(Ct.is,Ct);E("vaadin-input-container",y`
    :host {
...
`;E("",Hi,{moduleId:"lumo-required-field"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Go=y`
...
`,$i=[Hi,Bi,Wo,Go];E("",$i,{moduleId:"lumo-input-field-shared-styles"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Uo=y`
...
`;E("vaadin-text-area",[$i,Uo],{moduleId:"lumo-text-area"});/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const qo=o=>class extends o{static get properties(){return{disabled:{type:Boolean,reflectToAttribute:!0},readonly:{type:Boolean,reflectToAttribute:!0},invalid:{type:Boolean,reflectToAttribute:!0}}}ready(){super.ready(),this.addEventListener("pointerdown",e=>{e.target===this&&e.preventDefault()}),this.addEventListener("click",e=>{e.target===this&&this.shadowRoot.querySelector("slot:not([name])").assignedNodes({flatten:!0}).forEach(t=>t.focus&&t.focus())})}};/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const jo=y`
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */E("vaadin-input-container",jo,{moduleId:"vaadin-input-container-styles"});class Ko extends qo($(ue(k))){static get is(){return"vaadin-input-container"}static get template(){return M`
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */E("vaadin-text-area",[Jo,Ir],{moduleId:"vaadin-text-area-styles"});class Sr extends Er($(se(k))){static get is(){return"vaadin-text-area"}static get template(){return M`
    ...
    `}ready(){super.ready(),this._tooltipController=new Lt(this),this._tooltipController.setPosition("top"),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}}D(Sr);const Tr=y`
  :host([theme~='margin']) {
...
`;E("vaadin-vertical-layout",Tr,{moduleId:"lumo-vertical-layout"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Or extends se($(k)){static get template(){return M`
      <style>
        :host {
          display: flex;
          flex-direction: column;
      ...
      <slot></slot>
    `}static get is(){return"vaadin-vertical-layout"}}D(Or);E("vaadin-app-layout",y`
    [part='navbar'],
    [part='drawer'] {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function os(){if(De){const o=window.innerHeight,e=window.innerWidth>o,t=document.documentElement.clientHeight;e&&t>o?document.documentElement.style.setProperty("--vaadin-viewport-offset-bottom",`${t-o}px`):document.documentElement.style.setProperty("--vaadin-viewport-offset-bottom","")}}os();window.addEventListener("resize",os);const rs=document.createElement("template");rs.innerHTML=`
  <style>
...
`;document.head.appendChild(rs.content);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ke=!1,ns=[],as=[];function ls(){Ke=!0,requestAnimationFrame(function(){Ke=!1,zr(ns),setTimeout(function(){kr(as)})})}function zr(o){for(;o.length;)ds(o.shift())}function kr(o){for(let i=0,e=o.length;i<e;i++)ds(o.shift())}function ds(o){const i=o[0],e=o[1],t=o[2];try{e.apply(i,t)}catch(s){setTimeout(()=>{throw s})}}function Pr(o,i,e){Ke||ls(),ns.push([o,i,e])}function hs(o,i,e){Ke||ls(),as.push([o,i,e])}/**
 * @license
 * Copyright (c) 2017 Anton Korzunov
 * SPDX-License-Identifier: MIT
 */let _e=new WeakMap,Ve=new WeakMap,We={},ct=0;const li=o=>o&&o.nodeType===Node.ELEMENT_NODE,ut=(...o)=>{console.error(`Error: ${o.join(" ")}. Skip setting aria-hidden.`)},Rr=(o,i)=>li(o)?i.map(e=>{if(!li(e))return ut(e,"is not a valid element"),null;let t=e;for(;t&&t!==o;){if(o.contains(t))return e;t=t.getRootNode().host}return ut(e,"is not contained inside",o),null}).filter(e=>!!e):(ut(o,"is not a valid element"),[]),Dr=(o,i,e,t)=>{const s=Rr(i,Array.isArray(o)?o:[o]);We[e]||(We[e]=new WeakMap);const r=We[e],n=[],a=new Set,l=new Set(s),u=f=>{if(!f||a.has(f))return;a.add(f);const g=f.assignedSlot;g&&u(g),u(f.parentNode||f.host)};s.forEach(u);const p=f=>{if(!f||l.has(f))return;const g=f.shadowRoot;(g?[...f.children,...g.children]:[...f.children]).forEach(x=>{if(!["template","script","style"].includes(x.localName))if(a.has(x))p(x);else{const O=x.getAttribute(t),w=O!==null&&O!=="false",B=(_e.get(x)||0)+1,H=(r.get(x)||0)+1;_e.set(x,B),r.set(x,H),n.push(x),B===1&&w&&Ve.set(x,!0),H===1&&x.setAttribute(e,"true"),w||x.setAttribute(t,"true")}})};return p(i),a.clear(),ct+=1,()=>{n.forEach(f=>{const g=_e.get(f)-1,C=r.get(f)-1;_e.set(f,g),r.set(f,C),g||(Ve.has(f)?Ve.delete(f):f.removeAttribute(t)),C||f.removeAttribute(e)}),ct-=1,ct||(_e=new WeakMap,_e=new WeakMap,Ve=new WeakMap,We={})}},Lr=(o,i=document.body,e="data-aria-hidden")=>{const t=Array.from(Array.isArray(o)?o:[o]);return i&&t.push(...Array.from(i.querySelectorAll("[aria-live]"))),Dr(t,i,e,"aria-hidden")};/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class cs{constructor(i,e){this.host=i,this.callback=typeof e=="function"?e:()=>i}showModal(){const i=this.callback();this.__showOthers=Lr(i)}close(){this.__showOthers&&(this.__showOthers(),this.__showOthers=null)}}/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const _t=[];class us{constructor(i){this.host=i,this.__trapNode=null,this.__onKeyDown=this.__onKeyDown.bind(this)}get __focusableElements(){return or(this.__trapNode)}get __focusedElementIndex(){const i=this.__focusableElements;return i.indexOf(i.filter(qi).pop())}hostConnected(){document.addEventListener("keydown",this.__onKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this.__onKeyDown)}trapFocus(i){if(this.__trapNode=i,this.__focusableElements.length===0)throw this.__trapNode=null,new Error("The trap node should have at least one focusable descendant or be focusable itself.");_t.push(this),this.__focusedElementIndex===-1&&this.__focusableElements[0].focus()}releaseFocus(){this.__trapNode=null,_t.pop()}__onKeyDown(i){if(this.__trapNode&&this===Array.from(_t).pop()&&i.key==="Tab"){i.preventDefault();const e=i.shiftKey;this.__focusNextElement(e)}}__focusNextElement(i=!1){const e=this.__focusableElements,t=i?-1:1,s=this.__focusedElementIndex,r=(e.length+s+t)%e.length,n=e[r];n.focus(),n.localName==="input"&&n.select()}}/**
 * @license
 * Copyright (c) 2018 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Fr extends se($(re(k))){static get template(){return M`
      <style>
        :host {
          display: block;
          box-sizing: border-box;
...
`;E("",Vt,{moduleId:"lumo-overlay"});const Mr=y`
  :host {
...
`;E("vaadin-tooltip-overlay",[Vt,Mr],{moduleId:"lumo-tooltip-overlay"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const _s=y`
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Nr{saveFocus(i){this.focusNode=i||xt()}restoreFocus(){const i=this.focusNode;i&&(xt()===document.body?setTimeout(()=>i.focus()):i.focus(),this.focusNode=null)}}/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ps=o=>class extends re(o){static get properties(){return{focusTrap:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!1},restoreFocusNode:{type:HTMLElement}}}constructor(){super(),this.__ariaModalController=new cs(this),this.__focusTrapController=new us(this),this.__focusRestorationController=new Nr}ready(){super.ready(),this.addController(this.__ariaModalController),this.addController(this.__focusTrapController),this.addController(this.__focusRestorationController)}_resetFocus(){this.focusTrap&&(this.__ariaModalController.close(),this.__focusTrapController.releaseFocus()),this.restoreFocusOnClose&&this._shouldRestoreFocus()&&this.__focusRestorationController.restoreFocus()}_saveFocus(){this.restoreFocusOnClose&&this.__focusRestorationController.saveFocus(this.restoreFocusNode)}_trapFocus(){this.focusTrap&&(this.__ariaModalController.showModal(),this.__focusTrapController.trapFocus(this.$.overlay))}_shouldRestoreFocus(){const e=xt();return e===document.body||this._deepContains(e)}_deepContains(e){if(this.contains(e))return!0;let t=e;const s=e.ownerDocument;for(;t&&t!==s&&t!==this;)t=t.parentNode||t.host;return t===this}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ue=()=>Array.from(document.body.children).filter(o=>o instanceof HTMLElement&&o._hasOverlayStackMixin&&!o.hasAttribute("closing")).sort((o,i)=>o.__zIndex-i.__zIndex||0),Br=o=>o===Ue().pop(),Hr=o=>class extends o{constructor(){super(),this._hasOverlayStackMixin=!0}get _last(){return Br(this)}bringToFront(){let e="";const t=Ue().filter(s=>s!==this).pop();t&&(e=t.__zIndex+1),this.style.zIndex=e,this.__zIndex=e||parseFloat(getComputedStyle(this).zIndex)}_enterModalState(){document.body.style.pointerEvents!=="none"&&(this._previousDocumentPointerEvents=document.body.style.pointerEvents,document.body.style.pointerEvents="none"),Ue().forEach(e=>{e!==this&&(e.$.overlay.style.pointerEvents="none")})}_exitModalState(){this._previousDocumentPointerEvents!==void 0&&(document.body.style.pointerEvents=this._previousDocumentPointerEvents,delete this._previousDocumentPointerEvents);const e=Ue();let t;for(;(t=e.pop())&&!(t!==this&&(t.$.overlay.style.removeProperty("pointer-events"),!t.modeless)););}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const fs=o=>class extends ps(Hr(o)){static get properties(){return{opened:{type:Boolean,notify:!0,observer:"_openedChanged",reflectToAttribute:!0},owner:{type:Object},model:{type:Object},renderer:{type:Object},modeless:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_modelessChanged"},hidden:{type:Boolean,reflectToAttribute:!0,observer:"_hiddenChanged"},withBackdrop:{type:Boolean,value:!1,reflectToAttribute:!0}}}static get observers(){return["_rendererOrDataChanged(renderer, owner, model, opened)"]}constructor(){super(),this._boundMouseDownListener=this._mouseDownListener.bind(this),this._boundMouseUpListener=this._mouseUpListener.bind(this),this._boundOutsideClickListener=this._outsideClickListener.bind(this),this._boundKeydownListener=this._keydownListener.bind(this),De&&(this._boundIosResizeListener=()=>this._detectIosNavbar())}ready(){super.ready(),this.addEventListener("click",()=>{}),this.$.backdrop.addEventListener("click",()=>{}),this.addEventListener("mouseup",()=>{document.activeElement===document.body&&this.$.overlay.getAttribute("tabindex")==="0"&&this.$.overlay.focus()})}connectedCallback(){super.connectedCallback(),this._boundIosResizeListener&&(this._detectIosNavbar(),window.addEventListener("resize",this._boundIosResizeListener))}disconnectedCallback(){super.disconnectedCallback(),this._boundIosResizeListener&&window.removeEventListener("resize",this._boundIosResizeListener)}requestContentUpdate(){this.renderer&&this.renderer.call(this.owner,this,this.owner,this.model)}close(e){const t=new CustomEvent("vaadin-overlay-close",{bubbles:!0,cancelable:!0,detail:{sourceEvent:e}});this.dispatchEvent(t),t.defaultPrevented||(this.opened=!1)}_detectIosNavbar(){if(!this.opened)return;const e=window.innerHeight,s=window.innerWidth>e,r=document.documentElement.clientHeight;s&&r>e?this.style.setProperty("--vaadin-overlay-viewport-bottom",`${r-e}px`):this.style.setProperty("--vaadin-overlay-viewport-bottom","0")}_addGlobalListeners(){document.addEventListener("mousedown",this._boundMouseDownListener),document.addEventListener("mouseup",this._boundMouseUpListener),document.documentElement.addEventListener("click",this._boundOutsideClickListener,!0)}_removeGlobalListeners(){document.removeEventListener("mousedown",this._boundMouseDownListener),document.removeEventListener("mouseup",this._boundMouseUpListener),document.documentElement.removeEventListener("click",this._boundOutsideClickListener,!0)}_rendererOrDataChanged(e,t,s,r){const n=this._oldOwner!==t||this._oldModel!==s;this._oldModel=s,this._oldOwner=t;const a=this._oldRenderer!==e,l=this._oldRenderer!==void 0;this._oldRenderer=e;const u=this._oldOpened!==r;this._oldOpened=r,a&&l&&(this.innerHTML="",delete this._$litPart$),r&&e&&(a||u||n)&&this.requestContentUpdate()}_modelessChanged(e){e?(this._removeGlobalListeners(),this._exitModalState()):this.opened&&(this._addGlobalListeners(),this._enterModalState())}_openedChanged(e,t){e?(this._saveFocus(),this._animatedOpening(),hs(this,()=>{this._trapFocus();const s=new CustomEvent("vaadin-overlay-open",{bubbles:!0});this.dispatchEvent(s)}),document.addEventListener("keydown",this._boundKeydownListener),this.modeless||this._addGlobalListeners()):t&&(this._resetFocus(),this._animatedClosing(),document.removeEventListener("keydown",this._boundKeydownListener),this.modeless||this._removeGlobalListeners())}_hiddenChanged(e){e&&this.hasAttribute("closing")&&this._flushAnimation("closing")}_shouldAnimate(){const e=getComputedStyle(this),t=e.getPropertyValue("animation-name");return!(e.getPropertyValue("display")==="none")&&t&&t!=="none"}_enqueueAnimation(e,t){const s=`__${e}Handler`,r=n=>{n&&n.target!==this||(t(),this.removeEventListener("animationend",r),delete this[s])};this[s]=r,this.addEventListener("animationend",r)}_flushAnimation(e){const t=`__${e}Handler`;typeof this[t]=="function"&&this[t]()}_animatedOpening(){this.parentNode===document.body&&this.hasAttribute("closing")&&this._flushAnimation("closing"),this._attachOverlay(),this.modeless||this._enterModalState(),this.setAttribute("opening",""),this._shouldAnimate()?this._enqueueAnimation("opening",()=>{this._finishOpening()}):this._finishOpening()}_attachOverlay(){this._placeholder=document.createComment("vaadin-overlay-placeholder"),this.parentNode.insertBefore(this._placeholder,this),document.body.appendChild(this),this.bringToFront()}_finishOpening(){this.removeAttribute("opening")}_finishClosing(){this._detachOverlay(),this.$.overlay.style.removeProperty("pointer-events"),this.removeAttribute("closing"),this.dispatchEvent(new CustomEvent("vaadin-overlay-closed"))}_animatedClosing(){this.hasAttribute("opening")&&this._flushAnimation("opening"),this._placeholder&&(this._exitModalState(),this.setAttribute("closing",""),this.dispatchEvent(new CustomEvent("vaadin-overlay-closing")),this._shouldAnimate()?this._enqueueAnimation("closing",()=>{this._finishClosing()}):this._finishClosing())}_detachOverlay(){this._placeholder.parentNode.insertBefore(this,this._placeholder),this._placeholder.parentNode.removeChild(this._placeholder)}_mouseDownListener(e){this._mouseDownInside=e.composedPath().indexOf(this.$.overlay)>=0}_mouseUpListener(e){this._mouseUpInside=e.composedPath().indexOf(this.$.overlay)>=0}_shouldCloseOnOutsideClick(e){return this._last}_outsideClickListener(e){if(e.composedPath().includes(this.$.overlay)||this._mouseDownInside||this._mouseUpInside){this._mouseDownInside=!1,this._mouseUpInside=!1;return}if(!this._shouldCloseOnOutsideClick(e))return;const t=new CustomEvent("vaadin-overlay-outside-click",{bubbles:!0,cancelable:!0,detail:{sourceEvent:e}});this.dispatchEvent(t),this.opened&&!t.defaultPrevented&&this.close(e)}_keydownListener(e){if(this._last&&!(this.modeless&&!e.composedPath().includes(this.$.overlay))&&e.key==="Escape"){const t=new CustomEvent("vaadin-overlay-escape-press",{bubbles:!0,cancelable:!0,detail:{sourceEvent:e}});this.dispatchEvent(t),this.opened&&!t.defaultPrevented&&this.close(e)}}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const pt={start:"top",end:"bottom"},ft={start:"left",end:"right"},di=new ResizeObserver(o=>{setTimeout(()=>{o.forEach(i=>{i.target.__overlay&&i.target.__overlay._updatePosition()})})}),ms=o=>class extends o{static get properties(){return{positionTarget:{type:Object,value:null,sync:!0},horizontalAlign:{type:String,value:"start",sync:!0},verticalAlign:{type:String,value:"top",sync:!0},noHorizontalOverlap:{type:Boolean,value:!1,sync:!0},noVerticalOverlap:{type:Boolean,value:!1,sync:!0},requiredVerticalSpace:{type:Number,value:0,sync:!0}}}static get observers(){return["__positionSettingsChanged(horizontalAlign, verticalAlign, noHorizontalOverlap, noVerticalOverlap, requiredVerticalSpace)","__overlayOpenedChanged(opened, positionTarget)"]}constructor(){super(),this.__onScroll=this.__onScroll.bind(this),this._updatePosition=this._updatePosition.bind(this)}connectedCallback(){super.connectedCallback(),this.opened&&this.__addUpdatePositionEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.__removeUpdatePositionEventListeners()}__addUpdatePositionEventListeners(){window.visualViewport.addEventListener("resize",this._updatePosition),window.visualViewport.addEventListener("scroll",this.__onScroll,!0),this.__positionTargetAncestorRootNodes=xo(this.positionTarget),this.__positionTargetAncestorRootNodes.forEach(e=>{e.addEventListener("scroll",this.__onScroll,!0)})}__removeUpdatePositionEventListeners(){window.visualViewport.removeEventListener("resize",this._updatePosition),window.visualViewport.removeEventListener("scroll",this.__onScroll,!0),this.__positionTargetAncestorRootNodes&&(this.__positionTargetAncestorRootNodes.forEach(e=>{e.removeEventListener("scroll",this.__onScroll,!0)}),this.__positionTargetAncestorRootNodes=null)}__overlayOpenedChanged(e,t){if(this.__removeUpdatePositionEventListeners(),t&&(t.__overlay=null,di.unobserve(t),e&&(this.__addUpdatePositionEventListeners(),t.__overlay=this,di.observe(t))),e){const s=getComputedStyle(this);this.__margins||(this.__margins={},["top","bottom","left","right"].forEach(r=>{this.__margins[r]=parseInt(s[r],10)})),this.setAttribute("dir",s.direction),this._updatePosition(),requestAnimationFrame(()=>this._updatePosition())}}__positionSettingsChanged(){this._updatePosition()}__onScroll(e){e.target instanceof Node&&this.contains(e.target)||this._updatePosition()}_updatePosition(){if(!this.positionTarget||!this.opened)return;const e=this.positionTarget.getBoundingClientRect(),t=this.__shouldAlignStartVertically(e);this.style.justifyContent=t?"flex-start":"flex-end";const s=this.__isRTL,r=this.__shouldAlignStartHorizontally(e,s),n=!s&&r||s&&!r;this.style.alignItems=n?"flex-start":"flex-end";const a=this.getBoundingClientRect(),l=this.__calculatePositionInOneDimension(e,a,this.noVerticalOverlap,pt,this,t),u=this.__calculatePositionInOneDimension(e,a,this.noHorizontalOverlap,ft,this,r);Object.assign(this.style,l,u),this.toggleAttribute("bottom-aligned",!t),this.toggleAttribute("top-aligned",t),this.toggleAttribute("end-aligned",!n),this.toggleAttribute("start-aligned",n)}__shouldAlignStartHorizontally(e,t){const s=Math.max(this.__oldContentWidth||0,this.$.overlay.offsetWidth);this.__oldContentWidth=this.$.overlay.offsetWidth;const r=Math.min(window.innerWidth,document.documentElement.clientWidth),n=!t&&this.horizontalAlign==="start"||t&&this.horizontalAlign==="end";return this.__shouldAlignStart(e,s,r,this.__margins,n,this.noHorizontalOverlap,ft)}__shouldAlignStartVertically(e){const t=this.requiredVerticalSpace||Math.max(this.__oldContentHeight||0,this.$.overlay.offsetHeight);this.__oldContentHeight=this.$.overlay.offsetHeight;const s=Math.min(window.innerHeight,document.documentElement.clientHeight),r=this.verticalAlign==="top";return this.__shouldAlignStart(e,t,s,this.__margins,r,this.noVerticalOverlap,pt)}__shouldAlignStart(e,t,s,r,n,a,l){const u=s-e[a?l.end:l.start]-r[l.end],p=e[a?l.start:l.end]-r[l.start],f=n?u:p,C=f>(n?p:u)||f>t;return n===C}__adjustBottomProperty(e,t,s){let r;if(e===t.end){if(t.end===pt.end){const n=Math.min(window.innerHeight,document.documentElement.clientHeight);if(s>n&&this.__oldViewportHeight){const a=this.__oldViewportHeight-n;r=s-a}this.__oldViewportHeight=n}if(t.end===ft.end){const n=Math.min(window.innerWidth,document.documentElement.clientWidth);if(s>n&&this.__oldViewportWidth){const a=this.__oldViewportWidth-n;r=s-a}this.__oldViewportWidth=n}}return r}__calculatePositionInOneDimension(e,t,s,r,n,a){const l=a?r.start:r.end,u=a?r.end:r.start,p=parseFloat(n.style[l]||getComputedStyle(n)[l]),f=this.__adjustBottomProperty(l,r,p),g=t[a?r.start:r.end]-e[s===a?r.end:r.start],C=f?`${f}px`:`${p+g*(a?-1:1)}px`;return{[l]:C,[u]:""}}};/**
 * @license
 * Copyright (c) 2022 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const $r=o=>class extends ms(fs(o)){static get properties(){return{position:{type:String,reflectToAttribute:!0}}}requestContentUpdate(){if(super.requestContentUpdate(),this.toggleAttribute("hidden",this.textContent.trim()===""),this.positionTarget&&this.owner){const e=getComputedStyle(this.owner);["top","bottom","start","end"].forEach(t=>{this.style.setProperty(`--vaadin-tooltip-offset-${t}`,e.getPropertyValue(`--vaadin-tooltip-offset-${t}`))})}}_updatePosition(){if(super._updatePosition(),!!this.positionTarget){if(this.position==="bottom"||this.position==="top"){const e=this.positionTarget.getBoundingClientRect(),t=this.$.overlay.getBoundingClientRect(),s=e.width/2-t.width/2;if(this.style.left){const r=t.left+s;r>0&&(this.style.left=`${r}px`)}if(this.style.right){const r=parseFloat(this.style.right)+s;r>0&&(this.style.right=`${r}px`)}}if(this.position==="start"||this.position==="end"){const e=this.positionTarget.getBoundingClientRect(),t=this.$.overlay.getBoundingClientRect(),s=e.height/2-t.height/2;this.style.top=`${t.top+s}px`}}}};/**
 * @license
 * Copyright (c) 2022 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Vr=y`
...
`;E("vaadin-item",Cs,{moduleId:"lumo-item"});const jr=y`
...
`;E("vaadin-context-menu-item",[Cs,jr],{moduleId:"lumo-context-menu-item"});const xs=y`
  :host {
    -webkit-tap-highlight-color: transparent;
...
`;E("vaadin-list-box",xs,{moduleId:"lumo-list-box"});const Kr=y`
  :host {
...
`;E("vaadin-context-menu-list-box",[xs,Kr],{moduleId:"lumo-context-menu-list-box"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ws=y`
...
`;E("",ws,{moduleId:"lumo-menu-overlay-core"});const Yr=y`
...
`,As=[Vt,ws,Yr];E("",As,{moduleId:"lumo-menu-overlay"});const Qr=y`
  :host([phone]) {
...
`;E("vaadin-context-menu-overlay",[As,Qr],{moduleId:"lumo-context-menu-overlay"});/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */tt({name:"vaadin-contextmenu",deps:["touchstart","touchmove","touchend","contextmenu"],flow:{start:["touchstart","contextmenu"],end:["contextmenu"]},emits:["vaadin-contextmenu"],info:{sourceEvent:null},reset(){this.info.sourceEvent=null,this._cancelTimer(),this.info.touchJob=null,this.info.touchStartCoords=null},_cancelTimer(){this._timerId&&(clearTimeout(this._timerId),delete this._fired)},_setSourceEvent(o){this.info.sourceEvent=o;const i=o.composedPath();this.info.sourceEvent.__composedPath=i},touchstart(o){this._setSourceEvent(o),this.info.touchStartCoords={x:o.changedTouches[0].clientX,y:o.changedTouches[0].clientY};const i=o.composedPath()[0]||o.target;this._timerId=setTimeout(()=>{const e=o.changedTouches[0];o.shiftKey||(De&&(this._fired=!0,this.fire(i,e.clientX,e.clientY)),be("tap"))},500)},touchmove(o){const e=this.info.touchStartCoords;(Math.abs(e.x-o.changedTouches[0].clientX)>15||Math.abs(e.y-o.changedTouches[0].clientY)>15)&&this._cancelTimer()},touchend(o){this._fired&&o.preventDefault(),this._cancelTimer()},contextmenu(o){o.shiftKey||(this._setSourceEvent(o),this.fire(o.target,o.clientX,o.clientY),be("tap"))},fire(o,i,e){const t=this.info.sourceEvent,s=new Event("vaadin-contextmenu",{bubbles:!0,cancelable:!0,composed:!0});s.detail={x:i,y:e,sourceEvent:t},o.dispatchEvent(s),s.defaultPrevented&&t&&t.preventDefault&&t.preventDefault()}});/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Es=o=>class extends Nt(it(o)){get _activeKeys(){return[" "]}ready(){super.ready(),he(this,"down",e=>{this._shouldSetActive(e)&&this._setActive(!0)}),he(this,"up",()=>{this._setActive(!1)})}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(e){return!this.disabled}_onKeyDown(e){super._onKeyDown(e),this._shouldSetActive(e)&&this._activeKeys.includes(e.key)&&(this._setActive(!0),document.addEventListener("keyup",t=>{this._activeKeys.includes(t.key)&&this._setActive(!1)},{once:!0}))}_setActive(e){this.toggleAttribute("active",e)}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Xr=o=>class extends Es(Ki(o)){static get properties(){return{_hasVaadinItemMixin:{value:!0},selected:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_selectedChanged"},_value:String}}get _activeKeys(){return["Enter"," "]}get value(){return this._value!==void 0?this._value:this.textContent.trim()}set value(e){this._value=e}ready(){super.ready();const e=this.getAttribute("value");e!==null&&(this.value=e)}focus(){this.disabled||(super.focus(),this._setFocused(!0))}_shouldSetActive(e){return!this.disabled&&!(e.type==="keydown"&&e.defaultPrevented)}_selectedChanged(e){this.setAttribute("aria-selected",e)}_disabledChanged(e){super._disabledChanged(e),e&&(this.selected=!1,this.blur())}_onKeyDown(e){super._onKeyDown(e),this._activeKeys.includes(e.key)&&!e.defaultPrevented&&(e.preventDefault(),this.click())}};/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Zr extends Xr($(ue(k))){static get is(){return"vaadin-context-menu-item"}static get template(){return M`
      <style>
        :host {
          display: inline-block;
        }
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */E("vaadin-context-menu-overlay",[_s,rn],{moduleId:"vaadin-context-menu-overlay-styles"});class nn extends on(fs(ue($(k)))){static get is(){return"vaadin-context-menu-overlay"}static get template(){return M`
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class an{constructor(i,e){this.query=i,this.callback=e,this._boundQueryHandler=this._queryHandler.bind(this)}hostConnected(){this._removeListener(),this._mediaQuery=window.matchMedia(this.query),this._addListener(),this._queryHandler(this._mediaQuery)}hostDisconnected(){this._removeListener()}_addListener(){this._mediaQuery&&this._mediaQuery.addListener(this._boundQueryHandler)}_removeListener(){this._mediaQuery&&this._mediaQuery.removeListener(this._boundQueryHandler),this._mediaQuery=null}_queryHandler(i){typeof this.callback=="function"&&this.callback(i.matches)}}/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;E("vaadin-horizontal-layout",cn,{moduleId:"lumo-horizontal-layout"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class un extends se($(k)){static get template(){return M`
      <style>
        :host {
          display: flex;
          box-sizing: border-box;
      ...
      <slot></slot>
    `}static get is(){return"vaadin-horizontal-layout"}}D(un);E("vaadin-checkbox",y`
    :host {
  ...
  `,{moduleId:"lumo-checkbox"});E("vaadin-grid",y`
    :host {
      font-family: var(--lumo-font-family);
      font-size: var(--lumo-font-size-m);
      line-height: var(--lumo-line-height-s);
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */E("vaadin-grid",Bn,{moduleId:"vaadin-grid-styles"});class ze extends Nn(se($(re(k)))){static get template(){return M`
      <div
        id="scroller"
        safari$="[[_safari]]"
        ios$="[[_ios]]"
    ...
    `}static get is(){return"vaadin-grid"}}D(ze);E("vaadin-grid-sorter",y`
    :host {
      justify-content: flex-start;
...
`;document.head.appendChild(ks.content);E("vaadin-grid-sorter",y`
    :host {
      display: inline-flex;
      cursor: pointer;
      max-width: 100%;
 ...
 */class $n extends Hn($(ue(k))){static get template(){return M`
    ...
    `}static get is(){return"vaadin-grid-sorter"}}D($n);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Vn=F(o=>class extends is(Nt(Bt(o))){static get properties(){return{checked:{type:Boolean,value:!1,notify:!0,reflectToAttribute:!0}}}static get delegateProps(){return[...super.delegateProps,"checked"]}_onChange(e){const t=e.target;this._toggleChecked(t.checked)}_toggleChecked(e){this.checked=e}});/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Wn extends Fe{constructor(i,e){super(i,"input","input",{initializer:(t,s)=>{s.value&&(t.value=s.value),s.type&&t.setAttribute("type",s.type),t.id=this.defaultId,typeof e=="function"&&e(t)},useUniqueId:!0})}}/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Gn=o=>class extends es(Vn(Qi(Es(o)))){static get properties(){return{indeterminate:{type:Boolean,notify:!0,value:!1,reflectToAttribute:!0},name:{type:String,value:""},tabindex:{type:Number,value:0,reflectToAttribute:!0}}}static get delegateProps(){return[...super.delegateProps,"indeterminate"]}static get delegateAttrs(){return[...super.delegateAttrs,"name"]}constructor(){super(),this._setType("checkbox"),this.value="on"}ready(){super.ready(),this.addController(new Wn(this,e=>{this._setInputElement(e),this._setFocusElement(e),this.stateTarget=e,this.ariaTarget=e})),this.addController(new ss(this.inputElement,this._labelController))}_shouldSetActive(e){return e.target.localName==="a"?!1:super._shouldSetActive(e)}_toggleChecked(e){this.indeterminate&&(this.indeterminate=!1),super._toggleChecked(e)}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Un=y`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */E("vaadin-checkbox",Un,{moduleId:"vaadin-checkbox-styles"});class qn extends Gn(se($(k))){static get is(){return"vaadin-checkbox"}static get template(){return M`
      ...
      <slot name="tooltip"></slot>
    `}ready(){super.ready(),this._tooltipController=new Lt(this),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}}D(qn);(function(){const o=function(i){return window.Vaadin.Flow.tryCatchWrapper(i,"Vaadin Grid")};window.Vaadin.Flow.gridConnector={initLazy:i=>o(function(e){if(e.$connector)return;const t=e._dataProviderController;t.ensureFlatIndexHierarchyOriginal=t.ensureFlatIndexHierarchy,t.ensureFlatIndexHierarchy=o(function(d){const{item:h}=this.getFlatIndexContext(d);if(!h||!this.isExpanded(h))return;e.$connector.hasCacheForParentKey(e.getItemId(h))?this.ensureFlatIndexHierarchyOriginal(d):e.$connector.beforeEnsureFlatIndexHierarchy(d,h)}),t.isLoadingOriginal=t.isLoading,t.isLoading=o(function(){return e.$connector.hasEnsureSubCacheQueue()||this.isLoadingOriginal()});const s={},r={},n={},a=50,l=20;let u=[],p,f=[],g;const C=150;let x,O={};const w="null";O[w]=[0,0];let B=null,H=null;const ne=["SINGLE","NONE","MULTI"];let z={},T="SINGLE",V=!1;e.size=0,e.itemIdPath="key";function ye(d){return{[e.itemIdPath]:d}}e.$connector={},e.$connector.hasCacheForParentKey=o(d=>{var h;return((h=n[d])==null?void 0:h.size)!==void 0}),e.$connector.hasEnsureSubCacheQueue=o(()=>f.length>0),e.$connector.hasParentRequestQueue=o(()=>u.length>0),e.$connector.hasRootRequestQueue=o(()=>Object.keys(s).length>0||!!(x!=null&&x.isActive())),e.$connector.beforeEnsureFlatIndexHierarchy=o(function(d,h){f.push({flatIndex:d,itemkey:e.getItemId(h)}),g=Y.debounce(g,Qt,()=>{for(;f.length;)e.$connector.flushEnsureSubCache()})}),e.$connector.doSelection=o(function(d,h){T==="NONE"||!d.length||h&&e.hasAttribute("disabled")||(T==="SINGLE"&&(z={}),d.forEach(c=>{c&&(z[c.key]=c,c.selected=!0,h&&e.$server.select(c.key));const _=!e.activeItem||!c||c.key!=e.activeItem.key;!h&&T==="SINGLE"&&_&&(e.activeItem=c)}),e.selectedItems=Object.values(z))}),e.$connector.doDeselection=o(function(d,h){if(T==="NONE"||!d.length||h&&e.hasAttribute("disabled"))return;const c=e.selectedItems.slice();for(;d.length;){const _=d.shift();for(let m=0;m<c.length;m++){const v=c[m];if((_==null?void 0:_.key)===v.key){c.splice(m,1);break}}_&&(delete z[_.key],delete _.selected,h&&e.$server.deselect(_.key))}e.selectedItems=c}),e.__activeItemChanged=o(function(d,h){T=="SINGLE"&&(d?z[d.key]||e.$connector.doSelection([d],!0):h&&z[h.key]&&(e.__deselectDisallowed?e.activeItem=h:e.$connector.doDeselection([h],!0)))}),e._createPropertyObserver("activeItem","__activeItemChanged",!0),e.__activeItemChangedDetails=o(function(d,h){e.__disallowDetailsOnClick||d==null&&h===void 0||(d&&!d.detailsOpened?e.$server.setDetailsVisible(d.key):e.$server.setDetailsVisible(null))}),e._createPropertyObserver("activeItem","__activeItemChangedDetails",!0),e.$connector._getSameLevelPage=o(function(d,h,c){if((h.parentItem?e.getItemId(h.parentItem):w)===d)return Math.floor(c/e.pageSize);const{parentCache:m,parentCacheIndex:v}=h;return m?this._getSameLevelPage(d,m,v):null}),e.$connector.flushEnsureSubCache=o(function(){const d=f.shift();return d?(t.ensureFlatIndexHierarchyOriginal(d.flatIndex),!0):!1}),e.$connector.debounceRootRequest=o(function(d){const h=e._hasData?C:0;x=Y.debounce(x,Xt.after(h),()=>{e.$connector.fetchPage((c,_)=>e.$server.setRequestedRange(c,_),d,w)})}),e.$connector.flushParentRequests=o(function(){const d=[];u.splice(0,l).forEach(({parentKey:h,page:c})=>{e.$connector.fetchPage((_,m)=>d.push({parentKey:h,firstIndex:_,size:m}),c,h)}),d.length&&e.$server.setParentRequestedRanges(d)}),e.$connector.debounceParentRequest=o(function(d,h){u=u.filter(c=>c.parentKey!==d),u.push({parentKey:d,page:h}),p=Y.debounce(p,Xt.after(a),()=>{for(;u.length;)e.$connector.flushParentRequests()})}),e.$connector.fetchPage=o(function(d,h,c){c===w&&(h=Math.min(h,Math.floor((e.size-1)/e.pageSize)));const _=e._getRenderedRows();let m=_.length>0?_[0].index:0,v=_.length>0?_[_.length-1].index:0,b=v-m,P=Math.max(0,m-b),A=Math.min(v+b,e._flatSize),I=[null,null];for(let U=P;U<=A;U++){const{cache:Ce,index:Rs}=t.getFlatIndexContext(U),xe=e.$connector._getSameLevelPage(c,Ce,Rs);xe!==null&&(I[0]=Math.min(I[0]??xe,xe),I[1]=Math.max(I[1]??xe,xe))}(I.some(U=>U===null)||h<I[0]||h>I[1])&&(I=[h,h]);let W=O[c]||[-1,-1];if(W[0]!=I[0]||W[1]!=I[1]){O[c]=I;let U=I[1]-I[0]+1;d(I[0]*e.pageSize,U*e.pageSize)}}),e.dataProvider=o(function(d,h){var _,m;if(d.pageSize!=e.pageSize)throw"Invalid pageSize";let c=d.page;if(d.parentItem){let v=e.getItemId(d.parentItem);r[v]||(r[v]={});const b=t.getItemContext(d.parentItem);(_=n[v])!=null&&_[c]&&b.subCache?(c=Math.min(c,Math.floor(n[v].size/e.pageSize)),f=[],h(n[v][c],n[v].size)):(r[v][c]=h,e.$connector.debounceParentRequest(v,c))}else{if(c=Math.min(c,Math.floor(e.size/e.pageSize)),e.size===0){h([],0);return}(m=n[w])!=null&&m[c]?h(n[w][c]):(s[c]=h,e.$connector.debounceRootRequest(c))}}),e.$connector.setSorterDirections=o(function(d){V=!0,setTimeout(o(()=>{try{const h=Array.from(e.querySelectorAll("vaadin-grid-sorter"));e._sorters.forEach(c=>{h.includes(c)||h.push(c)}),h.forEach(c=>{c.direction=null}),e.multiSortPriority!=="append"&&(d=d.reverse()),d.forEach(({column:c,direction:_})=>{h.forEach(m=>{m.getAttribute("path")===c&&(m.direction=_)})})}finally{V=!1}}))}),e._updateItem=o(function(d,h){ze.prototype._updateItem.call(e,d,h),d.hidden||Array.from(d.children).forEach(c=>{var _,m;Array.from(((m=(_=c==null?void 0:c._content)==null?void 0:_.__templateInstance)==null?void 0:m.children)||[]).forEach(v=>{v._attachRenderedComponentIfAble&&v._attachRenderedComponentIfAble(),Array.from((v==null?void 0:v.children)||[]).forEach(b=>{b._attachRenderedComponentIfAble&&b._attachRenderedComponentIfAble()})})}),T===ne[1]&&(d.removeAttribute("aria-selected"),Array.from(d.children).forEach(c=>c.removeAttribute("aria-selected")))});const Gt=o(function(d,h){if(d==null||e.$server.updateExpandedState==null)return;let c=e.getItemId(d);e.$server.updateExpandedState(c,h)});e.expandItem=o(function(d){Gt(d,!0),ze.prototype.expandItem.call(e,d)}),e.collapseItem=o(function(d){Gt(d,!1),ze.prototype.collapseItem.call(e,d)});const Ne=function(d){if(!d||!Array.isArray(d))throw"Attempted to call itemsUpdated with an invalid value: "+JSON.stringify(d);let h=Array.from(e.detailsOpenedItems),c=!1;for(let _=0;_<d.length;++_){const m=d[_];m&&(m.detailsOpened?e._getItemIndexInArray(m,h)<0&&h.push(m):e._getItemIndexInArray(m,h)>=0&&h.splice(e._getItemIndexInArray(m,h),1),z[m.key]&&(z[m.key]=m,m.selected=!0,c=!0))}e.detailsOpenedItems=h,c&&e.selectedItems.splice(0,e.selectedItems.length,...Object.values(z))},ot=function(d,h){let c;if((h||w)!==w){c=n[h][d];const _=ye(h),m=t.getItemContext(_);if(m&&m.subCache){const v=r[h],b=v&&v[d];Ut(d,c,b,m.subCache)}}else c=n[w][d],Ut(d,c,s[d],t.rootCache);return c},Ut=function(d,h,c,_){if(!c){let m=d*e.pageSize,v=m+e.pageSize;if(h){if(_&&_.items)for(let b=m;b<v;b++)_.items[b]&&(_.items[b]=h[b-m])}else if(_&&_.items)for(let b=m;b<v;b++)delete _.items[b]}},qt=function(){rt(),e.__updateVisibleRows()},rt=function(){t.recalculateFlatSize(),e._flatSize=t.flatSize},Be=function(d){if(!d||!e.$||e.$.items.childElementCount===0)return;const h=d.map(_=>_.key),c=e._getRenderedRows().filter(_=>_._item&&h.includes(_._item.key)).map(_=>_.index);c.length>0&&e.__updateVisibleRows(c[0],c[c.length-1])};e.$connector.set=o(function(d,h,c){if(d%e.pageSize!=0)throw"Got new data to index "+d+" which is not aligned with the page size of "+e.pageSize;let _=c||w;const m=d/e.pageSize,v=Math.ceil(h.length/e.pageSize);_===w&&(H=[m,m+v-1]);for(let b=0;b<v;b++){let P=m+b,A=h.slice(b*e.pageSize,(b+1)*e.pageSize);n[_]||(n[_]={}),n[_][P]=A,e.$connector.doSelection(A.filter(W=>W.selected)),e.$connector.doDeselection(A.filter(W=>!W.selected&&z[W.key]));const I=ot(P,_);I&&(Ne(I),Be(I))}});const jt=function(d){let h=d.parentUniqueKey||w;if(n[h]){for(let c in n[h])for(let _ in n[h][c])if(e.getItemId(n[h][c][_])===e.getItemId(d))return{page:c,index:_,parentKey:h}}return null};e.$connector.updateHierarchicalData=o(function(d){let h=[];for(let _=0;_<d.length;_++){let m=jt(d[_]);if(m){n[m.parentKey][m.page][m.index]=d[_];let v=m.parentKey+":"+m.page;h[v]||(h[v]={parentKey:m.parentKey,page:m.page})}}let c=Object.keys(h);for(let _=0;_<c.length;_++){let m=h[c[_]];const v=ot(m.page,m.parentKey);v&&(Ne(v),Be(v))}}),e.$connector.updateFlatData=o(function(d){for(let h=0;h<d.length;h++){let c=jt(d[h]);if(c){n[c.parentKey][c.page][c.index]=d[h];const _=parseInt(c.page)*e.pageSize+parseInt(c.index),{rootCache:m}=t;m.items[_]&&(m.items[_]=d[h])}}Ne(d),Be(d)}),e.$connector.clearExpanded=o(function(){e.expandedItems=[],f=[],u=[]});const Ps=function(){const d=O[w];if(!d||!B)return;const h=B[1]-B[0]+1,c=Array.from({length:h},(_,m)=>B[0]+m);if(H){const[_,m]=H;for(let v=_;v<=m;v++){const b=c.indexOf(v);b>=0&&c.splice(b,1)}}c.some(_=>_>=d[0]&&_<=d[1])&&(d[0]=-1,d[1]=-1)};e.$connector.clear=o(function(d,h,c){let _=c||w;if(!n[_]||Object.keys(n[_]).length===0)return;if(d%e.pageSize!=0)throw"Got cleared data for index "+d+" which is not aligned with the page size of "+e.pageSize;let m=Math.floor(d/e.pageSize),v=Math.ceil(h/e.pageSize);_===w&&(B=[m,m+v-1]);for(let A=0;A<v;A++){let I=m+A,W=n[_][I];e.$connector.doDeselection(W.filter(Ce=>z[Ce.key])),W.forEach(Ce=>e.closeItemDetails(Ce)),delete n[_][I];const U=ot(I,c);U&&Ne(U),Be(W)}let b=t.rootCache;if(c){const A=ye(_);b=t.getItemContext(A).subCache}const P=d+v*e.pageSize;for(let A=d;A<P;A++)delete b.items[A],b.removeSubCache(A);rt()}),e.$connector.reset=o(function(){e.size=0,He(n),He(t.rootCache.items),He(O),g&&g.cancel(),p&&p.cancel(),x&&x.cancel(),g=void 0,p=void 0,f=[],u=[],qt()});const He=d=>Object.keys(d).forEach(h=>delete d[h]);e.$connector.updateSize=d=>e.size=d,e.$connector.updateUniqueItemIdPath=d=>e.itemIdPath=d,e.$connector.expandItems=o(function(d){let h=Array.from(e.expandedItems);d.filter(c=>!e._isExpanded(c)).forEach(c=>h.push(c)),e.expandedItems=h}),e.$connector.collapseItems=o(function(d){let h=Array.from(e.expandedItems);d.forEach(c=>{let _=e._getItemIndexInArray(c,h);_>=0&&h.splice(_,1)}),e.expandedItems=h,d.forEach(c=>e.$connector.removeFromQueue(c))}),e.$connector.removeFromQueue=o(function(d){let h=e.getItemId(d);Object.values(r[h]||{}).forEach(c=>c([])),delete r[h],f=f.filter(c=>c.itemkey!==h),u=u.filter(c=>c.parentKey!==h)}),e.$connector.confirmParent=o(function(d,h,c){n[h]||(n[h]={});const _=n[h].size!==c;n[h].size=c,c===0&&(n[h][0]=[]);let m=Object.getOwnPropertyNames(r[h]||{});for(let v=0;v<m.length;v++){let b=m[v],P=O[h]||[0,0];const A=r[h][b];if(n[h]&&n[h][b]||b<P[0]||b>P[1]){delete r[h][b];let I=n[h][b]||new Array(c);A(I,c)}else A&&c===0&&(delete r[h][b],A([],c))}if(_&&m.length===0){const v=ye(h),b=t.getItemContext(v);b&&b.subCache&&(b.subCache.size=c),rt()}e.$server.confirmParentUpdate(d,h),e.loading||(e.__confirmParentUpdateDebouncer=Y.debounce(e.__confirmParentUpdateDebouncer,Qt,()=>e.__updateVisibleRows()))}),e.$connector.confirm=o(function(d){var c;let h=Object.getOwnPropertyNames(s);for(let _=0;_<h.length;_++){let m=h[_],v=O[w]||[0,0];const b=e.size?Math.ceil(e.size/e.pageSize)-1:0,P=Math.min(v[1],b),A=s[m];(c=n[w])!=null&&c[m]||m<v[0]||+m>P?(delete s[m],n[w][m]?A(n[w][m]):(A(new Array(e.pageSize)),e.requestContentUpdate())):A&&e.size===0&&(delete s[m],A([]))}Ps(),H=null,B=null,e.$server.confirmUpdate(d)}),e.$connector.ensureHierarchy=o(function(){for(let d in n)d!==w&&delete n[d];He(O),t.rootCache.removeSubCaches(),qt()}),e.$connector.setSelectionMode=o(function(d){if((typeof d=="string"||d instanceof String)&&ne.indexOf(d)>=0)T=d,z={},e.$connector.updateMultiSelectable();else throw"Attempted to set an invalid selection mode"}),e.$connector.updateMultiSelectable=o(function(){e.$&&(T===ne[0]?e.$.table.setAttribute("aria-multiselectable",!1):T===ne[1]?e.$.table.removeAttribute("aria-multiselectable"):e.$.table.setAttribute("aria-multiselectable",!0))}),e._createPropertyObserver("isAttached",()=>e.$connector.updateMultiSelectable());const Kt=d=>h=>{d&&(d(h),d=null)};e.$connector.setHeaderRenderer=o(function(d,h){const{content:c,showSorter:_,sorterPath:m}=h;if(c===null){d.headerRenderer=null;return}d.headerRenderer=Kt(v=>{v.innerHTML="";let b=v;if(_){const P=document.createElement("vaadin-grid-sorter");P.setAttribute("path",m);const A=c instanceof Node?c.textContent:c;A&&P.setAttribute("aria-label",`Sort by ${A}`),v.appendChild(P),b=P}c instanceof Node?b.appendChild(c):b.textContent=c})}),e.__applySorters=()=>{const d=e._mapSorters(),h=JSON.stringify(e._previousSorters)!==JSON.stringify(d);e._previousSorters=d,ze.prototype.__applySorters.call(e),h&&!V&&e.$server.sortersChanged(d)},e.$connector.setFooterRenderer=o(function(d,h){const{content:c}=h;if(c===null){d.footerRenderer=null;return}d.footerRenderer=Kt(_=>{_.innerHTML="",c instanceof Node?_.appendChild(c):_.textContent=c})}),e.addEventListener("vaadin-context-menu-before-open",o(function(d){const{key:h,columnId:c}=d.detail;e.$server.updateContextMenuTargetItem(h,c)})),e.getContextMenuBeforeOpenDetail=o(function(d){var v,b;const h=d.detail.sourceEvent||d,c=e.getEventContext(h),_=((v=c.item)==null?void 0:v.key)||"",m=((b=c.column)==null?void 0:b.id)||"";return{key:_,columnId:m}}),e.preventContextMenu=o(function(d){const h=d.type==="click",{column:c}=e.getEventContext(d);return h&&c instanceof Ct}),e.addEventListener("click",o(d=>Yt(d,"item-click"))),e.addEventListener("dblclick",o(d=>Yt(d,"item-double-click"))),e.addEventListener("column-resize",o(d=>{e._getColumnsInOrder().filter(c=>!c.hidden).forEach(c=>{c.dispatchEvent(new CustomEvent("column-drag-resize"))}),e.dispatchEvent(new CustomEvent("column-drag-resize",{detail:{resizedColumnKey:d.detail.resizedColumn._flowId}}))})),e.addEventListener("column-reorder",o(d=>{const h=e._columnTree.slice(0).pop().filter(c=>c._flowId).sort((c,_)=>c._order-_._order).map(c=>c._flowId);e.dispatchEvent(new CustomEvent("column-reorder-all-columns",{detail:{columns:h}}))})),e.addEventListener("cell-focus",o(d=>{const h=e.getEventContext(d);["header","body","footer"].indexOf(h.section)!==-1&&e.dispatchEvent(new CustomEvent("grid-cell-focus",{detail:{itemKey:h.item?h.item.key:null,internalColumnId:h.column?h.column._flowId:null,section:h.section}}))}));function Yt(d,h){if(d.defaultPrevented)return;const c=d.target;if(Ss(c)||c instanceof HTMLLabelElement)return;const _=e.getEventContext(d),m=_.section;_.item&&m!=="details"&&(d.itemKey=_.item.key,_.column&&(d.internalColumnId=_.column._flowId),e.dispatchEvent(new CustomEvent(h,{detail:d})))}e.cellClassNameGenerator=o(function(d,h){const c=h.item.style;if(c)return(c.row||"")+" "+(d&&c[d._flowId]||"")}),e.cellPartNameGenerator=o(function(d,h){const c=h.item.part;if(c)return(c.row||"")+" "+(d&&c[d._flowId]||"")}),e.dropFilter=o(d=>d.item&&!d.item.dropDisabled),e.dragFilter=o(d=>d.item&&!d.item.dragDisabled),e.addEventListener("grid-dragstart",o(d=>{e._isSelected(d.detail.draggedItems[0])?(e.__selectionDragData?Object.keys(e.__selectionDragData).forEach(h=>{d.detail.setDragData(h,e.__selectionDragData[h])}):(e.__dragDataTypes||[]).forEach(h=>{d.detail.setDragData(h,d.detail.draggedItems.map(c=>c.dragData[h]).join(`
 ...
 */class Kn extends jn(k){static get is(){return"vaadin-grid-column-group"}}D(Kn);const Xe=window;Xe.Vaadin=Xe.Vaadin||{};Xe.Vaadin.setLitRenderer=(o,i,e,t,s,r)=>{const n=Function(`
  ...
  `)(Ci,xi,t),a=(l,u,p)=>{const{item:f}=p;l.__litRenderer!==a&&(l.innerHTML="",delete l._$litPart$,l.__litRenderer=a);const g={};for(const C in f)C.startsWith(r)&&(g[C.replace(r,"")]=f[C]);n(l,{...p,item:g},f.key)};a.__rendererId=r,o[i]=a};Xe.Vaadin.unsetLitRenderer=(o,i,e)=>{var t;((t=o[i])==null?void 0:t.__rendererId)===e&&(o[i]=void 0)};const tl=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"}));export{Es as A,Ko as B,re as C,Nt as D,Yi as E,Ki as F,wr as G,De as H,Cr as I,Zn as J,it as K,ss as L,tl as M,fs as O,ms as P,Gi as R,Vi as S,Lt as T,mn as V,$i as a,_s as b,Tt as c,gs as d,ts as e,Bt as f,Wi as g,qi as h,Cs as i,Me as j,Jo as k,xr as l,ws as m,Wn as n,Vt as o,Ot as p,Y as q,es as r,Vn as s,Qi as t,Hi as u,Wo as v,yr as w,Bi as x,Fe as y,ja as z};
