import{i as Q,m as j,g as P,V as he,p as G,D as pe,C as me,a as E,R as ge}from"./chunk-be2136a05c5be734851c1407e3884a3c6db24e95e94a1e32449f227fe52a5124-CZKy0Xe6.js";import{o as W,i as H,h as v,D as L,P as _,a as Ae,b as fe,O as ve,g as Y,I as _e,c as be,C as V,V as ye,F as D,K as X,d as xe,e as J,f as Ce,j as z,k as Z,l as K,m as R,L as M,T as O,E as S,t as Ie,n as we,p as Ee,A as Be,r as Se,q as ke,s as Fe,S as Pe,u as ee,v as B,w as Ve}from"./generated-flow-imports-B3Hchl7V.js";import{i as u,r as h,d as A,T as b,B as Te,x as N}from"./indexhtml-iJWIKTLQ.js";import{O as ze}from"./chunk-09d0b7c8457f156ff064d8a3ad4d36018d5a3e1e79a553b397db5fbe41d1b17d-C-xW-Zml.js";const te=u`
  :host {
...
`;h("vaadin-combo-box-item",[Q,te],{moduleId:"lumo-combo-box-item"});/**
 * @license
...
`;h("vaadin-combo-box-overlay",[W,j,oe,ie,re,u`
      :host {
...
`;h("vaadin-combo-box-overlay",[fe,Re],{moduleId:"vaadin-combo-box-overlay-styles"});class Me extends ae(ve(L(b(_)))){static get is(){return"vaadin-combo-box-overlay"}static get template(){return v`
 ...
 */h("vaadin-combo-box",Z,{moduleId:"vaadin-combo-box-styles"});class Ue extends le(de($e(K(b(S(_)))))){static get is(){return"vaadin-combo-box"}static get template(){return v`
    ...
    `}static get properties(){return{_positionTarget:{type:Object}}}get clearElement(){return this.$.clearButton}ready(){super.ready(),this.addController(new R(this,i=>{this._setInputElement(i),this._setFocusElement(i),this.stateTarget=i,this.ariaTarget=i})),this.addController(new M(this.inputElement,this._labelController)),this._tooltipController=new O(this),this.addController(this._tooltipController),this._tooltipController.setPosition("top"),this._tooltipController.setAriaTarget(this.inputElement),this._tooltipController.setShouldShow(i=>!i.opened),this._positionTarget=this.shadowRoot.querySelector('[part="input-field"]'),this._toggleElement=this.$.toggleButton}_onClearButtonClick(i){i.stopPropagation(),super._onClearButtonClick(i)}_onHostClick(i){const e=i.composedPath();(e.includes(this._labelNode)||e.includes(this._positionTarget))&&super._onHostClick(i)}}A(Ue);(function(){const s=function(i){return window.Vaadin.Flow.tryCatchWrapper(i,"Vaadin Combo Box")};window.Vaadin.Flow.comboBoxConnector={initLazy:i=>s(function(e){if(e.$connector)return;e.$connector={};const t={};let o={},r="";const n=new window.Vaadin.ComboBoxPlaceholder,c=(()=>{let a="",l=!1;return{needsDataCommunicatorReset:()=>l=!0,getLastFilterSentToServer:()=>a,requestData:(f,I,w)=>{const T=I-f,$=w.filter;e.$server.setRequestedRange(f,T,$),a=$,l&&(e.$server.resetDataCommunicator(),l=!1)}}})(),g=(a=Object.keys(t))=>{a.forEach(l=>{t[l]([],e.size),delete t[l];const d=parseInt(l)*e.pageSize,p=d+e.pageSize,m=Math.min(p,e.filteredItems.length);for(let f=d;f<m;f++)e.filteredItems[f]=n})};e.dataProvider=function(a,l){if(a.pageSize!=e.pageSize)throw"Invalid pageSize";if(e._clientSideFilter)if(o[0]){x(o[0],a.filter,l);return}else a.filter="";if(a.filter!==r){o={},r=a.filter,this._filterDebouncer=pe.debounce(this._filterDebouncer,Ie.after(500),()=>{if(c.getLastFilterSentToServer()===a.filter&&c.needsDataCommunicatorReset(),a.filter!==r)throw new Error("Expected params.filter to be '"+r+"' but was '"+a.filter+"'");this._filterDebouncer=void 0,g(),e.dataProvider(a,l)});return}if(this._filterDebouncer){t[a.page]=l;return}if(o[a.page])y(a.page,l);else{t[a.page]=l;const p=Math.max(a.pageSize*2,500),m=Object.keys(t).map(w=>parseInt(w)),f=Math.min(...m),I=Math.max(...m);if(m.length*a.pageSize>p)a.page===f?g([String(I)]):g([String(f)]),e.dataProvider(a,l);else if(I-f+1!==m.length)g();else{const w=a.pageSize*f,T=a.pageSize*(I+1);c.requestData(w,T,a)}}},e.$connector.clear=s((a,l)=>{const d=Math.floor(a/e.pageSize),p=Math.ceil(l/e.pageSize);for(let m=d;m<d+p;m++)delete o[m]}),e.$connector.filter=s(function(a,l){return l=l?l.toString().toLowerCase():"",e._getItemLabel(a,e.itemLabelPath).toString().toLowerCase().indexOf(l)>-1}),e.$connector.set=s(function(a,l,d){if(d!=c.getLastFilterSentToServer())return;if(a%e.pageSize!=0)throw"Got new data to index "+a+" which is not aligned with the page size of "+e.pageSize;if(a===0&&l.length===0&&t[0]){o[0]=[];return}const p=a/e.pageSize,m=Math.ceil(l.length/e.pageSize);for(let f=0;f<m;f++){let I=p+f,w=l.slice(f*e.pageSize,(f+1)*e.pageSize);o[I]=w}}),e.$connector.updateData=s(function(a){const l=new Map(a.map(d=>[d.key,d]));e.filteredItems=e.filteredItems.map(d=>l.get(d.key)||d)}),e.$connector.updateSize=s(function(a){e._clientSideFilter||(e.size=a)}),e.$connector.reset=s(function(){g(),o={},e.clearCache()}),e.$connector.confirm=s(function(a,l){if(l!=c.getLastFilterSentToServer())return;let d=Object.getOwnPropertyNames(t);for(let p=0;p<d.length;p++){let m=d[p];o[m]&&y(m,t[m])}e.$server.confirmUpdate(a)});const y=s(function(a,l){let d=o[a];e._clientSideFilter?x(d,e.filter,l):(delete o[a],l(d,e.size))}),x=s(function(a,l,d){let p=a;l&&(p=a.filter(m=>e.$connector.filter(m,l))),d(p,p.length)});e.addEventListener("custom-value-set",s(a=>a.preventDefault()))})(i)}})();window.Vaadin.ComboBoxPlaceholder=C;h("vaadin-radio-button",u`
    :host {
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-radio-button",Qe,{moduleId:"vaadin-radio-button-styles"});class je extends qe(S(b(V(_)))){static get is(){return"vaadin-radio-button"}static get template(){return v`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-radio-group",He,{moduleId:"vaadin-radio-group-styles"});class Ye extends We(S(b(_))){static get is(){return"vaadin-radio-group"}static get template(){return v`
  ...
  `,{moduleId:"lumo-progress-bar"});const ue=document.createElement("template");ue.innerHTML=`
  <style>
    @keyframes vaadin-progress-pulse3 {
      0% { opacity: 1; }
      10% { opacity: 0; }
...
`;document.head.appendChild(ue.content);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Xe=u`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-progress-bar",Xe,{moduleId:"vaadin-progress-bar-styles"});class Ze extends S(b(Je(_))){static get is(){return"vaadin-progress-bar"}static get template(){return v`
      <div part="bar">
        <div part="value"></div>
      </div>
    `}}A(Ze);h("vaadin-upload",u`
    :host {
  ...
  `,{moduleId:"lumo-upload"});h("vaadin-upload-icon",u`
    :host::before {
  ...
  `,{moduleId:"lumo-upload-icon"});h("vaadin-upload-file-list",u`
...
`;h("vaadin-upload-file",[ee,Ke],{moduleId:"lumo-upload-file"});/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class et extends b(_){static get is(){return"vaadin-upload-icon"}static get template(){return v`
      <style>
        :host {
          display: inline-block;
        }
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ce=document.createElement("template");ce.innerHTML=`
  <style>
    @font-face {
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-upload-file",it,{moduleId:"vaadin-upload-file-styles"});class ot extends tt(b(V(_))){static get template(){return v`
      <div part="row">
        <div part="info">
    ...
    `}static get is(){return"vaadin-upload-file"}}A(ot);/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const rt=s=>class extends s{static get properties(){return{items:{type:Array},i18n:{type:Object}}}static get observers(){return["__updateItems(items, i18n)"]}__updateItems(e,t){e&&t&&this.requestContentUpdate()}requestContentUpdate(){const{items:e,i18n:t}=this;Te(N`
          ${e.map(o=>N`
              <li>
                <vaadin-upload-file
                  .file="${o}"
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class st extends rt(b(_)){static get is(){return"vaadin-upload-file-list"}static get template(){return v`
      <style>
        :host {
          display: block;
        }
 ...
 */class dt extends lt(S(b(V(_)))){static get template(){return v`
      ...
      <input
        ...
        capture$="[[capture]]"
      />
    `}static get is(){return"vaadin-upload"}}A(dt);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ut=u`
...
`;h("vaadin-multi-select-combo-box-chip",[ee,ut],{moduleId:"lumo-multi-select-combo-box-chip"});/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ct=u`
...
`;h("vaadin-multi-select-combo-box-item",[Q,te,ct],{moduleId:"lumo-multi-select-combo-box-item"});h("vaadin-multi-select-combo-box-overlay",[W,j,oe,ie,re,u`
      :host {
    ...
    `],{moduleId:"lumo-multi-select-combo-box-overlay"});h("vaadin-multi-select-combo-box-container",u`
...
`;h("vaadin-multi-select-combo-box",[H,ht],{moduleId:"lumo-multi-select-combo-box"});/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class pt extends b(_){static get is(){return"vaadin-multi-select-combo-box-chip"}static get properties(){return{disabled:{type:Boolean,reflectToAttribute:!0},readonly:{type:Boolean,reflectToAttribute:!0},label:{type:String},item:{type:Object}}}static get template(){return v`
      <style>
        :host {
          display: inline-flex;
          align-items: center;
    ...
    `}_onRemoveClick(i){i.stopPropagation(),this.dispatchEvent(new CustomEvent("item-removed",{detail:{item:this.item},bubbles:!0,composed:!0}))}}A(pt);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-multi-select-combo-box-container",u`
    #wrapper {
      display: flex;
      width: 100%;
      min-width: 0;
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-multi-select-combo-box-overlay",u`
    #overlay {
      width: var(
  ...
  `,{moduleId:"vaadin-multi-select-combo-box-overlay-styles"});let F;class At extends ae(ze){static get is(){return"vaadin-multi-select-combo-box-overlay"}static get template(){if(!F){F=super.template.cloneNode(!0);const i=F.content.querySelector('[part~="overlay"]');i.removeAttribute("tabindex");const e=document.createElement("div");e.setAttribute("part","loader"),i.insertBefore(e,i.firstElementChild)}return F}}A(At);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class ft extends ne(_){static get is(){return"vaadin-multi-select-combo-box-scroller"}static get template(){return v`
      <style>
        :host {
          display: block;
          min-height: 1px;
    ...
    `}ready(){super.ready(),this.setAttribute("aria-multiselectable","true")}_isItemSelected(i,e,t){return i instanceof C||this.owner.readonly?!1:this.owner._findIndex(i,this.owner.selectedItems,t)>-1}_updateElement(i,e){super._updateElement(i,e),i.toggleAttribute("readonly",this.owner.readonly)}}A(ft);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class vt extends le(de(b(_))){static get is(){return"vaadin-multi-select-combo-box-internal"}static get template(){return v`
      <style>
        :host([opened]) {
          pointer-events: auto;
        }
...
`;h("vaadin-multi-select-combo-box",[Z,_t],{moduleId:"vaadin-multi-select-combo-box-styles"});class bt extends ge(K(b(S(_)))){static get is(){return"vaadin-multi-select-combo-box"}static get template(){return v`
