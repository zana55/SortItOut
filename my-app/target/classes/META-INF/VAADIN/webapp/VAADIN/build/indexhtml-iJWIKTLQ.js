...
`;$n("spacing-props",eh);const ex=Ee`vaadin-button::part(label){font-size:16px}vaadin-multi-select-combo-box>label{display:inline-block;overflow:visible;text-overflow:clip;font-size:16px}vaadin-text-area>label{display:inline-block;overflow:visible;text-overflow:clip;font-size:16px}vaadin-grid::part(cell){font-size:16px}vaadin-radio-button>label{font-size:16px}vaadin-radio-group>label{font-size:16px}vaadin-checkbox>label{font-size:16px}vaadin-text-field::part(label){font-size:16px}[slot=drawer]:is(header,footer):is(:empty){display:none}html{--lumo-primary-color: plum;--lumo-primary-text-color: black;--lumo-secondary-text-color: purple}`,tx=e=>{const t=[];e!==document&&(t.push(lr(Au.cssText,"",e,!0)),t.push(lr(Iu.cssText,"",e,!0)),t.push(lr(eh.cssText,"",e,!0)),t.push(lr(Fu.cssText,"",e,!0)),t.push(lr(Uu.cssText,"",e,!0)),t.push(lr(ex.toString(),"",e)))},nx=tx;nx(document);export{$y as B,Ae as E,px as T,ks as _,w1 as a,bm as b,$n as c,T1 as d,Iu as e,Au as f,Ay as g,My as h,Ee as i,qn as j,Oy as k,ix as l,Ul as r,Jm as t,_y as x};
